...
<%@ page import="cn.zhsite.model.state.PaymentState" %><%--
...
<div id='wrapper' style="top: 50px">
    ...
    <section id='tools'>
        <ul class='breadcrumb' id='breadcrumb'>
            ...
            <li class="active"><a href="#">财务结算</a></li>
        </ul>
    </section>
    <!-- Content -->
    <div id='content'>
        ...
        <%for(Payment payment:paymentList) {
            ...
            if(payment.getState() == PaymentState.PREPAY){
        ...
        %>
            <tr class=''>
                ...
                <td class='action'>
                    <a class='btn btn-primary ${op1}' data-toggle='tooltip' href='/finance/payment/paymentSettle.do/${payment.id}' title='结算收款'>
                        <i class='icon-ok'></i>
                    </a>
                </td>
            </tr>
        ...
        %>
            <tr class=''>
                ...
                <td class='action'>
                    <a class='btn btn-primary' data-toggle='tooltip' href='/finance/payment/paybackSettle.do/${payback.id}' title='结算退款'>
                        <i class='icon-ok'></i>
                    </a>
                </td>
            </tr>
