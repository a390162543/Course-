    ...
    <div id='content'>
        ...
        %>
            <tr class=''>
                ...
                <td class='action'>
                    <a class='btn btn-primary ${op1}' data-toggle='tooltip' href='/manage/payment/paymentSettle.do/${payment.id}' title='结算收款'>
                        <i class='icon-ok'></i>
                    </a>
                </td>
            </tr>
        ...
        %>
            <tr class=''>
                ...
                <td class='action'>
                    <a class='btn btn-primary' data-toggle='tooltip' href='/manage/payment/paybackSettle.do/${payback.id}' title='结算退款'>
                        <i class='icon-ok'></i>
                    </a>
                </td>
            </tr>
