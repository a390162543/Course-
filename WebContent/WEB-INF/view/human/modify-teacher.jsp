...
<div class='wrapper' style="width: 500px">
    <div class='row'>
        <div class='col-lg-12'>
            <form method="post" action="/human/modifyTeacher.do">
                <fieldset>
                    <legend>修改教师信息</legend>
                </fieldset>
                <div class='form-group row hidden'>
                    <label class='control-label'>id</label>
                    <input class='form-control pull-right' type='text' name="id" value="${teacher.id}">
                </div>
                <div class='form-group row'>
                    <label class='control-label'>教师名称</label>
                    <input class='form-control pull-right' placeholder='请输入教师名称' type="text" name="name" value="${teacher.name}">
                </div>
                <div class='form-group row'>
                    <label class='control-label'>教师等级</label>
                    <input class='form-control pull-right' placeholder='请输入教师等级' type="text" name="level" value="${teacher.level}">
                </div>
                <div class='form-group row'>
                    <label class='control-label'>教师年龄</label>
                    <input class='form-control pull-right' placeholder='请输入教师年龄' type="text" name="age" value="${teacher.age}">
                </div>
