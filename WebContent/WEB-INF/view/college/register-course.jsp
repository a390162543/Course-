...
<div class='wrapper' style="width: 500px">
    <div class='row'>
        <div class='col-lg-12'>
            <form method="post" action="/college/registerCourse.do">
                <fieldset>
                    <legend>开设课程</legend>
                </fieldset>
                <div class='form-group row hidden'>
                    <label class='control-label'>id</label>
                    <input class='form-control pull-right' type='text' name="collegeId" value="${college.id}">
                </div>
                <div class='form-group row'>
                    <label class='control-label'>课程名称</label>
                    <input class='form-control pull-right' placeholder='请输入课程名称' type="text" name="name">
                </div>
                <div class='form-group row'>
                    <label class='control-label'>课程讲师</label>
                    <input class='form-control pull-right' placeholder='请输入课程讲师' type="text" name="teacher">
                </div>
                <div class='form-group row'>
                    <label class='control-label'>限制人数</label>
                    <input class='form-control pull-right' placeholder='请输入限制人数' type="text" name="limitNum">
                </div>
                <div class='form-group row'>
                    <label class='control-label'>课程价格</label>
                    <input class='form-control pull-right' placeholder='请输入课程价格' type="text" name="money">
                </div>
                <div class='form-group row'>
                    <label class='control-label'>开课时间</label>
                    <input class='form-control pull-right' placeholder='请选择开课时间' type="date" name="fromDate">
                </div>
                <div class='form-group row'>
                    <label class='control-label'>结课时间</label>
                    <input class='form-control pull-right' placeholder='请选择结课时间' type="date" name="toDate">
                </div>
