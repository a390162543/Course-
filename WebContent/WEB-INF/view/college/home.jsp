    ...
    <div id='content'>
        <div class="col-lg-6">
            ...
            <div class="row label-text">
                <label class="label">机构标识</label>
                <span class="text">${college.idString}</span>
            </div>
            <div class="row label-text">
            ...
            <div class="row label-text">
                ...
                <span class="text">${college.createTime}</span>
            </div>
            <div class="row label-text">
                <label class="label">机构状态</label>
                <span class="text">${college.state}</span>
            </div>
        </div>
        <div class="col-lg-6">
