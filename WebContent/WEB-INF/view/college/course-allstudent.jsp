...
<div id='wrapper' style="top: 50px">
    ...
    <section id='tools'>
        <ul class='breadcrumb' id='breadcrumb'>
            ...
            <li class="active"><a href="/college/course">课程管理</a></li>
    ...
    <div id='content'>
        ...
        <%for(Attend attend:attendList) {
            ...
            String op1 = "";
            String op2 = "";
            if(attend.getState() == AttendState.PRE|| attend.getState()==AttendState.CANCEL
                    || attend.getState() == AttendState.QUIT){
                op1 = "disabled";
            }
            if(attend.getState() != AttendState.ATTEND && attend.getState() != AttendState.PRE){
                op2 = "disabled";
            }
        ...
        %>
            <tr class=''>
                ...
                <td>${attend.studentType}</td>
                <td>${attend.student.idcard}</td>
                <td>${attend.state.chinese}</td>
                <td>${attend.score}</td>
                <td class='action'>
                    <a class='btn btn-warning ${op1}' data-toggle='tooltip' href='/college/course/score/${attend.id}' title='成绩登记'>
                        <i class='icon-pencil'></i>
                    </a>
                    <a class='btn btn-danger ${op2}' data-toggle='tooltip' href='/college/course/quit.do/${attend.id}' title='退出课程'>
